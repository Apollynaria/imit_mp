<template>
    <div id="title" class="h-screen">
        <nav class="flex flex-row justify-between p-3 transition-all duration-500 w-90 h-[15%] mx-auto max-w-screen-lg">
            <!-- not mobile -->
            <ul v-if="!mobile"
                ...
                <li v-for="url in urls_text" :key="url.name" class="p-3 ml-4">
                    <nuxt-link
                        class="text-[16px] transition-all duration-500 pb-1 border-b border-transparent hover:text-gray-500 hover:border-gray-500"
                        :to="url.name">
                        {{ url.text }}
                    </nuxt-link>
                </li>
                ...
                <li v-for="url in urls_icon" :key="url.name" class="ml-4">
                    <UTooltip :text=url.tooltip>
                        <nuxt-link
                            class="text-[16px] transition-all duration-500 pb-1 hover:text-gray-500"
                            :to="url.name">
            ...
            <ul v-else class="flex items-center justify-center font-medium w-full text-white list-none no-underline">
                <li class="p-3">
                    <Icon class="bar pb-1 transition-all duration-500 pb-1 hover:text-gray-500 " @click="toggleMobileNav" v-show="mobile"
                        name="iconamoon:menu-burger-horizontal-bold" size="40" />
                </li>
            </ul>
            <transition name="mobile-nav">
                <ul v-if="mobileNav"
                    class="flex flex-col fixed w-full max-w-[250px] h-full bg-gray-900 top-0 left-0 z-40"
                    ...
                    <li v-for="url in urls_mobile" :key="url.name" class="flex justify-start m-5">
                        <nuxt-link
                            class="text-[18px] transition-all duration-500 pb-1 border-b border-transparent hover:text-gray-300 hover:border-gray-300 text-white"
                            :to="url.name">
        ...
        <div class="h-[85%] flex flex-col items-center justify-center">
            <div>
                НАУЧНЫЕ МЕРОПРИЯТИЯ <br>
                ИМИТ ИГУ
            </div>
            <div class="flex justify-center">
                <img src="../imit_nobackground.png" class="w-[250px] transition-all duration-500 mt-3" alt="">
            </div>
        </div>

    </div>

    <div id="main" class="h-screen overflow-hidden ">
        <div id="stars"></div>
        <div id="stars2"></div>
    </div>
</template>
...
#main {
    background: radial-gradient(ellipse at bottom, #142437 10%, #090a0f 100%);
}

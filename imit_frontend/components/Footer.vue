...
<template>
    <footer class="flex flex-col border-t-[1px] border-gray-500 justify-center bg-[#142437]">
        ...
        <p class="text-center text-gray-100 ">&copy; 2024 Институт математики и информационных технологий</p>
    </footer>
</template>
